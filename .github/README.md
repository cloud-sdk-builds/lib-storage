...
[`@aws-sdk/lib-storage`](https://www.npmjs.com/package/@aws-sdk/lib-storage/v/3.185.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/lib-storage@3.185.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-3NB5xAfsINi9xWttwl0d6kEM0n8zGU5Ym3h2PwlnylYWRUn24sddQWGUu+PSBzym
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/lib-storage": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/lib-storage@3.185.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/lib-storage@3.185.0/index.min.mjs": "sha384-3NB5xAfsINi9xWttwl0d6kEM0n8zGU5Ym3h2PwlnylYWRUn24sddQWGUu+PSBzym"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/lib-storage/blob/refs/tags/3.185.0/LICENSE
```
