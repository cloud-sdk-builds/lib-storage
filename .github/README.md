...
[`@aws-sdk/lib-storage`](https://www.npmjs.com/package/@aws-sdk/lib-storage/v/3.112.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/lib-storage@3.112.0/index.min.mjs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/lib-storage": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/lib-storage@3.112.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/lib-storage@3.112.0/index.min.mjs": "sha384-YA9bC8qQfnNC5YDekMIHGkUiXD0bdutdu2uvy7w0uRZim0HOA95/XKj8TGXTZacU"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/lib-storage/blob/refs/tags/3.112.0/LICENSE
```
