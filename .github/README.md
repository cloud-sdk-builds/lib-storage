...
[`@aws-sdk/lib-storage`](https://www.npmjs.com/package/@aws-sdk/lib-storage/v/3.97.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/lib-storage@3.97.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-c+6kX/nrytzJJgfk8icn5W5EaRgvZJxPAtoxZK2cHU155elI4x1rqA5lISIPmwai
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/lib-storage": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/lib-storage@3.97.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/lib-storage@3.97.0/index.min.mjs": "sha384-c+6kX/nrytzJJgfk8icn5W5EaRgvZJxPAtoxZK2cHU155elI4x1rqA5lISIPmwai"
        }
      }
</script>
```
...
* Always pin to a specific version (`@3.97.0`)
...
```
https://github.com/cloud-sdk-builds/lib-storage/blob/refs/tags/3.97.0/LICENSE
```
