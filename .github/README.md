...
[`@aws-sdk/lib-storage`](https://www.npmjs.com/package/@aws-sdk/lib-storage/v/3.981.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/lib-storage@3.981.0/index.min.mjs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/lib-storage": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/lib-storage@3.981.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/lib-storage@3.981.0/index.min.mjs": "sha384-rebRSoGV8+W3MXG5rohLPQ5Y5HiC40RQ5m0Xmx6xxt1vfc5RBCsejaGLMulyoHVu"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/lib-storage/blob/refs/tags/3.981.0/LICENSE
```
