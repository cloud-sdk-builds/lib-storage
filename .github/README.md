...
[`@aws-sdk/lib-storage`](https://www.npmjs.com/package/@aws-sdk/lib-storage/v/3.896.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/lib-storage@3.896.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-A4XV4TEPseTlo4rZheFtNKMATUPF3lSp1KvElNTXK9kGi8veV9vDt8TSiUPq0dCJ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/lib-storage": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/lib-storage@3.896.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/lib-storage@3.896.0/index.min.mjs": "sha384-A4XV4TEPseTlo4rZheFtNKMATUPF3lSp1KvElNTXK9kGi8veV9vDt8TSiUPq0dCJ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/lib-storage/blob/refs/tags/3.896.0/LICENSE
```
