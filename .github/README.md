...
[`@aws-sdk/lib-storage`](https://www.npmjs.com/package/@aws-sdk/lib-storage/v/3.645.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/lib-storage@3.645.0/index.min.mjs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/lib-storage": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/lib-storage@3.645.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/lib-storage@3.645.0/index.min.mjs": "sha384-kMSyX+JkzlzLANZnI3epSPw3m3XqabySlaUR1fVgXPUdnWclByyWQ+O8/p3xYSrh"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/lib-storage/blob/refs/tags/3.645.0/LICENSE
```
