...
[`@aws-sdk/lib-storage`](https://www.npmjs.com/package/@aws-sdk/lib-storage/v/3.7.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/lib-storage@3.7.0/index.min.mjs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/lib-storage": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/lib-storage@3.7.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/lib-storage@3.7.0/index.min.mjs": "sha384-XffbAXWGdLJax+Z39WGl36RNXnwemwUIQ9qFAOPt0q6A91SNATmw7dbbbBQunTnQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/lib-storage/blob/refs/tags/3.7.0/LICENSE
```
