...
[`@aws-sdk/lib-storage`](https://www.npmjs.com/package/@aws-sdk/lib-storage/v/3.58.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/lib-storage@3.58.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-RNwerVSkD+XKi1DrkSdgWAwHmz+ZUMH9o234o79ZKqO7SiWO8xfDFzLtIcV2K8t/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/lib-storage": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/lib-storage@3.58.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/lib-storage@3.58.0/index.min.mjs": "sha384-RNwerVSkD+XKi1DrkSdgWAwHmz+ZUMH9o234o79ZKqO7SiWO8xfDFzLtIcV2K8t/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/lib-storage/blob/refs/tags/3.58.0/LICENSE
```
