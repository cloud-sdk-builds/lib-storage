...
[`@aws-sdk/lib-storage`](https://www.npmjs.com/package/@aws-sdk/lib-storage/v/3.932.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/lib-storage@3.932.0/index.min.mjs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/lib-storage": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/lib-storage@3.932.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/lib-storage@3.932.0/index.min.mjs": "sha384-/8CYAatHOekc5H9p2QrZtTIMVp2H8++kb1fIl1jhot6F2/ygfakvhI1egzX6/1XG"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/lib-storage/blob/refs/tags/3.932.0/LICENSE
```
